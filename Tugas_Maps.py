...
petaJawatengah.tambahkanKota("Pekalongan")
petaJawatengah.tambahkanKota("Magelang")
petaJawatengah.tambahkanKota("Tegal")
petaJawatengah.tambahkanKota("Surakarta")
petaJawatengah.tambahkanKota("Kudus")
petaJawatengah.tambahkanKota("Klaten")
petaJawatengah.tambahkanKota("Jepara")
petaJawatengah.tambahkanKota("Purwodadi")
petaJawatengah.tambahkanKota("Demak")
petaJawatengah.tambahkanKota("Purwokerto")
petaJawatengah.tambahkanKota("Boyolali")
petaJawatengah.tambahkanKota("Pati")
petaJawatengah.tambahkanKota("Pemalang")
petaJawatengah.tambahkanKota("Rembang")
petaJawatengah.tambahkanKota("Purworejo")
petaJawatengah.tambahkanKota("Wonogiri")
